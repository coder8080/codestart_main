...
!(function (t, e) {
    ...
    const t = (t) => {
        ...
        o = (t) =>
            s(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? document.querySelector(t) : null,
        r = (t, e, i) => {
    ...
    class Z extends H {
        ...
        _getItemIndex(t) {
            return (
                (this._items = t && t.parentNode ? U.find('.carousel-item', t.parentNode) : []), this._items.indexOf(t)
            )
        }
        _getItemByOrder(t, e) {
            const i = t === K
    ...
    class Le {
        ...
        _getConfig(t) {
            return (
                ((t = { ...Ce, ...('object' == typeof t ? t : {}) }).rootElement = o(t.rootElement)),
                r('backdrop', t, ke),
                t
            )
        }
    ...
    class Pe extends H {
        ...
        _getConfig(t) {
            return (
                (t = { ...Ne, ...F.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }),
                r('modal', t, Ie),
                t
            )
        }
